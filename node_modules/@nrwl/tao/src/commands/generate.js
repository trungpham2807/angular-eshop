...
function taoNew(cwd, args, isVerbose = false) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return params_1.handleErrors(isVerbose, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { normalizedGeneratorName, schema, implementation, } = ws.readGenerator(opts.collectionName, opts.generatorName);
            ...
            return (yield Promise.resolve().then(() => require('./ngcli-adapter'))).invokeNew(cwd, Object.assign(Object.assign({}, opts), { generatorOptions: combinedOpts }), isVerbose);
        }));
    });
}
