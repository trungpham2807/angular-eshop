    ...
    if (supportedNxCommands.includes(process.argv[2])) {
        ...
        if (workspace.type === 'nx') {
            ...
            if (process.argv[2] === 'update' &&
                ...
                console.log(`If you still want to use "ng update", run "FORCE_NG_UPDATE=true ng update".`);
            }
            else {
...
function runOneOptions(workspace) {
    try {
        const workspaceConfigJson = JSON.parse(fs
            ...
            .toString());
        return parse_run_one_options_1.parseRunOneOptions(workspace.dir, workspaceConfigJson, process.argv.slice(2));
    }
    catch (e) {
        return false;
    }
