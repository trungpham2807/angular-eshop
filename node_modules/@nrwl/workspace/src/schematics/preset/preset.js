...
function createPreset(options) {
    if (options.preset === 'empty') {
        ...
        return schematics_1.chain([
            ...
            addPolyfills(`apps/${devkit_1.names(options.name).fileName}/src/polyfills.ts`, [
...
export default App;
    `);
        host.overwrite(`apps/${options.name}/src/app/app.spec.tsx`, `import { cleanup, getByText, render, waitFor } from '@testing-library/react';
